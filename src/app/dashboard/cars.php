    ...
    <div class="row">
      ...
      <main class="col-12 col-md-9 col-lg-10 px-4 py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <button id="addCarBtn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#carModal">
          ...
          <table class="table table-dark table-hover table-bordered mb-0">
            ...
            <tbody>
              ...
              foreach ($cars as $row) {
                ...
                echo "<td>
                            <a href='/MostWanted/src/app/dashboard/update.php?car_id={$data}' class='btn btn-warning btn-sm me-1'>Edit</a>
