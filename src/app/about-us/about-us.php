...
<body>
  ...
  <section class="ftco-section ftco-intro driver" style="background-image: url(../../images/about-us.jpeg);">
    <div class="overlay"></div>
    <div class="container">
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <a class="navbar-brand" href="/MostWanted/src/app/home/home.php"><img style="width: 150px;  margin-bottom: 15px;" class="logo" src="../../images/logo1.png" alt=""></a>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              <li><a href="/MostWanted/src/app/home/home.php" class="py-2 d-block">Home</a></li>
          ...
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                ...
                <li><a href="#"><span class="text">Contact Us</span></a></li>
              </ul>
            </div>
          </div>
        </div>
