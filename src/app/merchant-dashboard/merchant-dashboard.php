...
if (
    ...
    $query .= " AND booking_date BETWEEN :dateFrom AND :dateTo";
...
<body>
    ...
    <div class="sidebar bg-dark vh-100 p-3 position-fixed">
        ...
        <nav class="nav flex-column">
            <a class="nav-link text-white" href="/MostWanted/src/app/merchant-dashboard/merchant-dashboard.php?userEmail=<?= $userEmail ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            <a class="nav-link text-white" href="/MostWanted/src/app/merchant-dashboard/merchant-cars.php?userEmail=<?= $userEmail ?>"><i class="fas fa-car"></i> Cars</a>
    ...
    <div class="content" style="padding:20px;">
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mb-4">
            <a class="navbar-brand" style='color:#FFB22C'>Admin Dashboard: <?= $user['email']; ?></a>
        </nav>
