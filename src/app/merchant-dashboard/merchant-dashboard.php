...
$stmt = $conn->prepare("SELECT COUNT(*) FROM Cars where user_name = :email");
$stmt->bindParam(':email', $userEmail);
$stmt->execute();
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <aside
        ...
        <h3 class="text-center text-white py-3">Merchant Panel</h3>
        <nav class="nav flex-column">
          <a
            href="/MostWanted/src/app/merchant-dashboard/merchant-dashboard.php?userEmail=<?= $userEmail ?>"
            class="nav-link text-white">
            <i class="fas fa-tachometer-alt me-2"></i>Dashboard
          </a>
          <a
            href="/MostWanted/src/app/merchant-dashboard/merchant-cars.php?userEmail=<?= $userEmail ?>"
            class="nav-link text-white">
