...
<body>
    ...
    <div class="sidebar bg-dark vh-100 p-3 position-fixed">
        <h3 class="text-center py-4 text-white">Merchant Panel</h3>
        <nav class="nav flex-column">
            <a class="nav-link text-white" href="/MostWanted/src/app/merchant-dashboard/merchant-dashboard.php?userEmail=<?= json_decode($userEmail) ?>"><i class="fas fa-tachometer-alt"></i>Dashboard</a>
            <a class="nav-link text-white" href="/MostWanted/src/app/merchant-dashboard/merchant-cars.php?userEmail=<?= json_decode($userEmail) ?>"><i class="fas fa-car"></i>Cars</a>
        ...
        <table class="table table-dark table-hover table-bordered shadow-sm">
            ...
            <tbody>
                ...
                foreach ($cars as $row) {
                    ...
                    echo "<td style = 'color:#129990'>{$row['plate_number']}</td>";
                    echo "<td>{$row['price']} JD</td>";
                    echo "<td style = 'color:#FFB22C'>{$row['available']}</td>";
                    echo "<td>                            
                            <a href='/MostWanted/src/app/merchant-dashboard/update.php?car_id={$data}' class='btn btn-warning btn-sm'>Edit</a>
